...
```{r}
rcval = raster("../data/covariate_data/croplayer/txcamp//CDL_2016_clip_20180118163303_1712778437.tif")

el = raster("../data/covariate_data/elevation/txcamp/imgn30w099_1.img")
...
df=200
fitlong = lm(longsc ~ bs(datetimef, df=df), data=pig1)
fitlat = lm(latsc ~ bs(datetimef, df=df), data=pig1)
